    ...
    <div class="flex flex-col items-start justify-around px-6 md:px-16 md:flex-row">
    	...
    	<div class="flex flex-col w-full items-center space-y-4 py-4 justify-start border-dark border-b-2 md:border-none md:w-1/2">
    		...
    		<div class="hidden md:block left-0 right-0 flex flex-col w-full md:w-1/2 space-y-2">
		    	...
		    	<a class="flex px-6 items-center justify-between hover:bg-cta hover:rounded-full hover:text-dark" href="" >
						<img src="{{ asset('images/autor2.png') }}" alt="imagen logo" class=" h-12">
						<p>Ilustrador</p>
					</a>
    	...
    	<div class="flex flex-col w-full items-center space-y-4 py-4 justify-start md:w-1/2 ">
    		...
    		<div class="hidden md:block left-0 right-0 flex flex-col w-full md:w-1/2 space-y-2">
	    		<a class="flex p-2 items-center justify-between hover:border-cta hover:border-b-2 " href="" ><p>Aviso Legal</p>	</a>
					<a class="flex p-2 items-center justify-between hover:border-cta hover:border-b-2 " href="" >	<p>Téminos y Condiciones</p></a>
    		</div>

    		<a href=""  class="w-full md:border-none text-center text-xl font-light">2023</a>
